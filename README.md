...
awsvault_version   | 6.1.0                                                                                                                                | Defined to dynamically fetch the desired version to install. Defaults to: **6.1.0**
